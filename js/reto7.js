...
// REGLA PARA DOCUMENTO DE IDENTIDAD
form.Nodoc.addEventListener('input', e => {
  ...
  if (number.test(e.target.value)) {
    ...
    f1.textContent="Solo puede digitar valores númericos con una longitud minimo de 5 y máximo de 10"
    f1.style.setProperty("visibility","visible")
    f1.style.setProperty("opacity","1")
  }
})

// REGLAS PARA LA PARTE DEL NOMBRE
form.Nom.addEventListener('input', e => {
  ...
  if (text.test(e.target.value)) {
    ...
    f2.textContent="Solo se aceptan valores alfanuméricos (mínimo 10 y máximo 20 caracteres)"
    f2.style.setProperty("visibility","visible")
    f2.style.setProperty("opacity","1")
  }
})

// REGLAS PARA LA PARTE DEL APELLIDO
...
// REGLAS PARA LA PARTE DEL FECHA DE NACIMIENTO
...
// REGLAS PARA LA PARTE DEL CORREO ELECTRÓNICO
...
// REGLAS PARA LA PARTE DEL CONTRASEÑA
...
// REGLAS PARA LA PARTE DEL CONFIRMAR CONTRASEÑA
